...
- [ ] Build outreach list of 50 ecommerce operators
- [ ] Offer free spend leakage audit
- [ ] Track dollars found per audit
- [ ] Track claims submitted and dollars recovered
...
- [ ] Add auth
- [ ] Add database
- [ ] Add Perplexity-assisted vendor policy research
- [ ] Add email integration
- [ ] Add vendor portal action workflows
- [ ] Add payment model for success fees
